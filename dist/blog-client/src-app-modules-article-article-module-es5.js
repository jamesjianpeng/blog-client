...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-modules-article-article-module"], {
  ...
  /***/
  function srcAppCoreServiceArticleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(ArticleService, [{
        key: "getArticles",
        value: function getArticles(data) {
          return this.http.get("".concat(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_1__["environment"].api, "/api/v1/get/articles?page=1&pageSize=10&type=doing&keyword=&startDate=&endDate="));
        }
      }, {
        key: "getArticle",
        value: function getArticle(id) {
          console.log("".concat(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_1__["environment"].api, "/api/v1/get/article/").concat(id));
          return this.http.get("".concat(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_1__["environment"].api, "/api/v1/get/article/").concat(id));
        }
      }]);
  ...
  /***/
  function srcAppCoreServiceConfigTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(ConfigService, [{
        ...
        value: function getTags() {
          return this.http.get("".concat(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_1__["environment"].api, "/api/v1/get/config/tags"));
        }
      }]);
  ...
  /***/
  function srcAppModulesArticleArticleRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_modules_article_pages_article_list_page_article_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/modules/article/pages/article-list-page/article-list.component */
    "./src/app/modules/article/pages/article-list-page/article-list.component.ts");
    /* harmony import */


    var src_app_modules_article_pages_article_detail_page_article_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/modules/article/pages/article-detail-page/article-detail.component */
  ...
  /***/
  function srcAppModulesArticleArticleModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_core_service_article__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/@core/service/article */
    "./src/app/@core/service/article.ts");
    /* harmony import */


    var src_app_core_service_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/@core/service/config */
    "./src/app/@core/service/config.ts");
    /* harmony import */
    ...
    var src_app_modules_article_pages_article_list_page_article_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/modules/article/pages/article-list-page/article-list.component */
    "./src/app/modules/article/pages/article-list-page/article-list.component.ts");
    /* harmony import */


    var src_app_modules_article_pages_article_detail_page_article_detail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/modules/article/pages/article-detail-page/article-detail.component */
    "./src/app/modules/article/pages/article-detail-page/article-detail.component.ts");
    ...
    ArticleModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [src_app_core_service_article__WEBPACK_IMPORTED_MODULE_2__["ArticleService"], src_app_core_service_config__WEBPACK_IMPORTED_MODULE_3__["ConfigService"]],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _article_routing_module__WEBPACK_IMPORTED_MODULE_4__["ArticleRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ArticleModule, {
        declarations: [src_app_modules_article_pages_article_list_page_article_list_component__WEBPACK_IMPORTED_MODULE_5__["ArticleListComponent"], src_app_modules_article_pages_article_detail_page_article_detail_component__WEBPACK_IMPORTED_MODULE_6__["ArticleDetailComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _article_routing_module__WEBPACK_IMPORTED_MODULE_4__["ArticleRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppModulesArticlePagesArticleDetailPageArticleDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_core_service_article__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/@core/service/article */
    "./src/app/@core/service/article.ts");
    /* harmony import */


    var src_app_core_service_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/@core/service/config */
    "./src/app/@core/service/config.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ArticleDetailComponent(articleService, configService, activatedRoute) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticleDetailComponent, [{
        ...
        return [{
          type: src_app_core_service_article__WEBPACK_IMPORTED_MODULE_1__["ArticleService"]
        }, {
          type: src_app_core_service_config__WEBPACK_IMPORTED_MODULE_2__["ConfigService"]
        }, {
  ...
  /***/
  function srcAppModulesArticlePagesArticleListPageArticleListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ArticleListComponent(articleService, configService) {
      ...
      _createClass(ArticleListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.articleService.getArticles({}).subscribe(function (_ref) {
            var data = _ref.data;
            _this2.articles = data.data;
            console.log(data);
          });
          this.configService.getTags().subscribe(function (_ref2) {
            var data = _ref2.data;
            _this2.tags = data;
          });
        }
    ...
    ArticleListComponent.ɵfac = function ArticleListComponent_Factory(t) {
      return new (t || ArticleListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core_service_article__WEBPACK_IMPORTED_MODULE_1__["ArticleService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core_service_config__WEBPACK_IMPORTED_MODULE_2__["ConfigService"]));
    };
    ...
    ArticleListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[1, "flex-h-flex-start-nowrap"], [1, "tag-box", "flex-shrink-0"], ["class", "tag", 4, "ngFor", "ngForOf"], [1, "content-box"], [4, "ngFor", "ngForOf"], [1, "tag"], ["routerLinkActive", "active", 1, "navbar-brand", 3, "routerLink"]],
...
//# sourceMappingURL=src-app-modules-article-article-module-es5.js.map